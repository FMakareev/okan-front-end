...
import TextField from '../../../../components/TextFieldBase/TextFieldBase';
    ...
    <form onSubmit={handleSubmit}>
      <Banner
        ...
        <Heading f={[4, 5, 6, 7]}>
          ...
          <br />
          <hr />
          <Field name={'descriptio'} component={SelectBase} mb={4} />
          <br />
          <hr />
          <Field name={'descriptio1111'} component={RichTextEditor} mb={4} />
          <br />
          <hr />
          <Field name={'descripti11'} component={Checkbox} mb={4} />
          <br />
          <hr />
          <Field name={'description1'} component={TextField} mb={4} />
          <br />
          <hr />
          <Table width={'100%'}>
            <Thead>
