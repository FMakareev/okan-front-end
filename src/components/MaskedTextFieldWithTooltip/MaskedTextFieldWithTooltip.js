...
import MaskedInputs from "../MaskedInput/MaskedInput";

/**
 * Компонент инпута с тултипом (Text Field With Tooltip)
 * @example ./TextFieldWithTooltip.example.md
 */
export class MaskedTextFieldWithTooltip extends PureComponent {
  static propTypes = {
    /** class */
...
export default MaskedTextFieldWithTooltip;
